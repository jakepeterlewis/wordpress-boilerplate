...
function html5blank_header_scripts()
{
    if (!is_admin()) {
    	...
    	wp_register_script('jquery', get_template_directory_uri() . '/-/js/libs/jquery-1.10.2.min.js', array(), '1.10.2', true); // Google CDN jQuery
        ...
        wp_register_script('modernizr', get_template_directory_uri() . '/-/js/libs/modernizr.min.js', array(), '2.6.2'); // Modernizr
        wp_enqueue_script('modernizr'); // Enqueue it!
        
        wp_register_script('html5blankscripts', get_template_directory_uri() . '/-/js/scripts-ck.js', array(), '1.0.0', true); // Custom scripts
...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/plugins/acf-repeater.zip', // The plugin source
		...
		// Worpress Contact Form 7 - Jquery Validation
		array(
